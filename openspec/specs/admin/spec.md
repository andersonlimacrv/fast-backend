...
## Purpose
Control plane administrativo do SaaS kernel (change A-admin-control-plane, ADR 0005): root único via CLI, staff global limitado, operações privilegiadas como ações nomeadas e auditadas. Backend-only (contrato para dashboard futuro).
