...
export const CreditUsageCard: React.FC&lt;CreditUsageCardProps&gt; = ({
  ...
  const handleDownload = () =&gt; {
    ...
    const rows = [usageHistory.map](http://usageHistory.map)((r) =&gt; [[r.date](http://r.date), r.model, r.credits, r.cost]);
    ...
    [a.download](http://a.download) = 'usage-history.csv';
  ...
  useEffect(() =&gt; {
    ...
    const handler = (e: MouseEvent) =&gt; {
      ...
      if (moreRef.current &amp;&amp; !moreRef.current.contains([e.target](http://e.target) as Node)) {

        setActivePopover((prev) =&gt; (prev === 'more' ? null : prev));

      }

      if (periodRef.current &amp;&amp; !periodRef.current.contains([e.target](http://e.target) as Node)) {
            ...
            &lt;AnimatePresence&gt;
              ...
              {activePopover === 'period' &amp;&amp; (
                ...
                &gt;
                  ...
                  {PERIOD_[OPTIONS.map](http://OPTIONS.map)((opt) =&gt; (
        ...
        &lt;div className="no-scrollbar bg-muted/50 overflow-x-auto"&gt;
          ...
          &lt;div className="border-border min-w-[500px] space-y-0.5 border-b px-4 py-2 sm:px-6 md:px-8"&gt;
            ...
            {usageHistory.length &gt; 0 ? (
              ...
              [usageHistory.map](http://usageHistory.map)((row, idx) =&gt; (
...
export const CreditUsageCard: React.FC&lt;CreditUsageCardProps&gt; = ({
  ...
  const handleDownload = () =&gt; {
    ...
    [a.download](http://a.download) = 'credit-usage.csv';
