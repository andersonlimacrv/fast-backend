/* Vendored from @animate-ui/components-radix-sheet (registry, 2026-09-16).
 * Local adaptations: XIcon (lucide) → X (@/lib/icons, golden rule).
 * Re-fetch from https://animate-ui.com/r/components-radix-sheet.json to update. */
