/* Vendored from @animate-ui/components-animate-tooltip (registry, 2026-09-16).
 * Local adaptations: 'use client' removed (Vite); motion/react-client → motion/react.
 * Re-fetch from https://animate-ui.com/r/components-animate-tooltip.json to update. */
...
} from '@/components/custom-ui/components/tooltip/primitive';
