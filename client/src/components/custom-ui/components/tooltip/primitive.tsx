/* Vendored from @animate-ui/primitives-animate-tooltip (registry, 2026-09-16).
 * Local adaptations: 'use client' removed (Vite). Requires @floating-ui/react.
 * Re-fetch from https://animate-ui.com/r/primitives-animate-tooltip.json to update. */
...
import { Slot, type WithAsChild } from '@/components/custom-ui/components/slot';
...
function shallowEqualWithoutChildren(
  ...
  for (const k of keysA) {
    // @ts-expect-error index access intentional
