/* Vendored from @animate-ui/components-radix-sidebar (upstream paste, 2026-09-16).
 * Local adaptations: 'use client' removed (Vite); PanelLeftIcon (lucide) →
 * PanelLeft (@/lib/icons, golden rule). Everything else byte-faithful.
 * asChild/Slot usage is upstream-owned (exception documented in design.md).
 * Do not hand-edit behaviour; re-paste from upstream to update. */
